                  ...
                  <div class="box-body">
                    <div class="form-group">
					 ...
					 <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="jk_dosen" value="<?php echo $data ['jk_dosen']; ?>" readonly>
                    </div>
					 <div class="form-group">
                      <label for="exampleInputEmail1">Agama</label>
                      <input type="text" class="form-control" name="agama_dosen" value="<?php echo $data ['agama_dosen']; ?>" >
                    </div>
					 <div class="form-group">
