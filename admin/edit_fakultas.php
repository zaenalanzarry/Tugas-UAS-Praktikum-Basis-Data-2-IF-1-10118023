            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Update Data Fakultas</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">Update Data Fakultas</li>
                        </ol>
                    </div>
                </div>
                <!-- ============================================================== -->
              ...
              <div class="box box-primary">
                ...
                <form role="form" action="update_fakultas.php" method="post">
				 <?php
							...
							$query_mysqli = mysqli_query($koneksi,"select * from fakultas WHERE id_fakultas='$id_fakultas'")or die(mysqli_error($koneksi));
				...
				?>
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="id_fakultas" value="<?php echo $data ['id_fakultas']; ?>" readonly >
                    </div>
					 <div class="form-group">
